...
def rsi_ma_hyper_tune(ticker):
    ...
    # Initialize variables to track the best and second-best results
    best_wealth = -float('inf')
    second_best_wealth = -float('inf')
    best_params = None
    second_best_params = None

    # Define the ranges for RSI and MA parameters
    window_range = range(10, 31, 1)  # Range of RSI window sizes
